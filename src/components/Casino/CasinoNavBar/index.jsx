        ...
        {userAuth && (
          <div className={classes.menuBtnContainer}>
            <Link href="/account/wallet">
              <Typography className={classes.chips}>Chips: {chips && chips.toString()}</Typography>
            </Link>
            <Button
              variant="contained"
              size="large"
            ...
            <SettingsPopUp
              options={['About', 'Sign Out', 'Contact', 'About Us']}
            />
          </div>
        )}
      </Toolbar>
