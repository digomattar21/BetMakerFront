...
export default function Layout({
  ...
  winningNumber,
    ...
    const BlankChip ='https://github.com/tfunk2/tyleRoulette/blob/main/src/images/blank-chip.png?raw=true'
    const Ribbon ='https://github.com/tfunk2/tyleRoulette/blob/main/src/images/ribbon.png?raw=true'
  ...
  return (
    ...
    >
      ...
      <section className="even-money-bets">
        ...
        <div className="bet-box even-money" onClick={() => increaseBet("red")}>
          ...
          <img className="diamond" alt="red diamond" src="https://github.com/tfunk2/tyleRoulette/blob/main/src/images/red-diamond.png?raw=true"></img>
        </div>
        <div
        ...
        >
          ...
          <img className="diamond" alt="black diamond" src="https://github.com/tfunk2/tyleRoulette/blob/main/src/images/black-diamond.png?raw=true"></img>
        </div>
    ...
    const useStyles = makeStyles((theme) => ({
        "layout-div": {
            ...
            fontWeight: 900,
            backgroundImage: "url(../images/blue-felt.jpg)",
        ...
        zeroes: {
            ...
            gridTemplateRows: "13.74vh 1.2vh 13.74vh",
            borderLeft: ".8vw rgb(22, 22, 22) solid",
            /* border-top: 3px rgb(22, 22, 22) solid, */
            boxShadow: "inset 0vh -1.15vh rgb(22, 22, 22)",
            borderRadius: "0px 0px 0px 10px",
        },
        
        "inside-and-columns" :{
            display: "grid",
            gridTemplateColumns: "0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 0.75vw 6vw 6vw",
            gridTemplateRows: "8.8vh 1.2vh 8.8vh 1.2vh 8.8vh 1.2vh" ,
            /* border: 2px rgb(22, 22, 22) solid, */
        },
        
        dozens :{
            display: "grid",
            gridTemplateColumns: "6.77vw 27vw 27.05vw 27.7vw",
            gridTemplateRows: "9.5vh",
            color: "rgb(22, 22, 22)",
        },
       ...
       "even-money-bets": {
            fontSize: "4.5vmin",
            display: "grid",
            gridTemplateColumns: "6.76vw 13.5vw 13.52vw 13.52vw 13.52vw 13.86vw 13.86vw",
        ...
        "zeroes-inside-columns": {
            display: "flex",
            width: "100%",
            borderTop: ".65vw rgb(22, 22, 22) solid",
        ...
        dozen :{
            borderBottom: ".75vw rgb(22, 22, 22) solid",
            borderLeft: ".75vw rgb(22, 22, 22) solid",
        },
        
        "right-dozen": {
            borderRight: ".75vw rgb(22, 22, 22) solid",
            borderBottom: ".75vw rgb(22, 22, 22) solid",
            borderLeft: ".75vw rgb(22, 22, 22) solid",
        },
        ...
        "@keyframes flashingNumber": {
            ...
            "50%": {backgroundColor: "rgba(255, 217, 0, 0)"},
